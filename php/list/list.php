...
<head>
    ...
    <title><?php echo $nameLists ?></title>
</head>
<body>
                    ...
                    <div class="table-users-search col-12">
                      <form action="todo/addTodo.php" method="post">
                        <div class="input-group mb-3">
                          <input type="hidden" value="<?php echo $idLists ?>" name="id">
                          <input type="text" class="form-control" placeholder="Enter New Todo" name="todo" aria-describedby="button-addon2">
                          <button class="btn btn-outline-secondary" type="submit" id="button-addon2" name="submit"><i class="fa-solid fa-plus"></i></button>
                        </div>
                      </form>
                    </div>
                  <table class="table">
                      ...
                      ?>
                        <tr>
                          <?php if ($checkbox == "false") {?>
                              <td class="td-info col-10" id="td-info"><?php echo $todo ?></td>
                          <?php } else { ?>
                              <td class="td-info col-10" id="td-info" style="text-decoration: line-through;"><?php echo $todo ?></td>
                          <?php } ?>
                          <td class="td-buttons col-2">
                              <?php if ($checkbox == "true") {?>
                                  <a href="todo/checbox.php?id=<?php echo $idTodo ?>&idLists=<?php echo $idLists ?>&checkbox=<?php echo $checkbox ?>" style="border: 2px solid #6a93cb; border-radius: 5px 5px 5px 5px; width: 20px; height: 20px; display: flex; justify-content: center; text-decoration: none; align-items: center; background-color: #6a93cb;"><i class="fa-solid fa-check" style="color: white; font-size: 15px;"></i></a>
                              <?php } else { ?>
                                <a href="todo/checbox.php?id=<?php echo $idTodo ?>&idLists=<?php echo $idLists ?>&checkbox=<?php echo $checkbox ?>" style="border: 2px solid #6a93cb; border-radius: 5px 5px 5px 5px; width: 20px; height: 20px; display: flex; justify-content: center; text-decoration: none; align-items: center;"></a>
                              <?php } ?>
                              <a href="todo/editTodo.php?id=<?php echo $idTodo ?>&idLists=<?php echo $idLists ?>&todo=<?php echo $todo ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                              <a href="todo/todoDelete.php?id=<?php echo $idTodo ?>&idLists=<?php echo $idLists ?>"><i class="fa-solid fa-trash"></i></a>
                          </td>
                        </tr>
                      <?php } ?>
                    </tbody>
